...
/* Exported constants --------------------------------------------------------*/
//#define HSD_TAGS_LABEL_LENGTH					(20U)
...
#define TAG_PINx_GPIO_CLK_ENABLE(__TAG_PIN__)     do {     if((__TAG_PIN__) == TAG_PIN0 ) { STMOD_PIN_7_GPIO_CLK_ENABLE(); } else \
                                                           if((__TAG_PIN__) == TAG_PIN1 ) { STMOD_PIN_8_GPIO_CLK_ENABLE(); } else \
                                                           if((__TAG_PIN__) == TAG_PIN2 ) { STMOD_PIN_9_GPIO_CLK_ENABLE(); } else \
                                                           if((__TAG_PIN__) == TAG_PIN3 ) { STMOD_PIN_10_GPIO_CLK_ENABLE(); } else \
                                                           if((__TAG_PIN__) == TAG_PIN4 ) { STMOD_PIN_11_GPIO_CLK_ENABLE(); } } while(0)

#define TAG_PINx_GPIO_CLK_DISABLE(__TAG_PIN__)  do {     if((__TAG_PIN__) == TAG_PIN0 ) { STMOD_PIN_7_GPIO_CLK_DISABLE(); } else \
                                                         if((__TAG_PIN__) == TAG_PIN1 ) { STMOD_PIN_8_GPIO_CLK_DISABLE(); } else \
                                                         if((__TAG_PIN__) == TAG_PIN2 ) { STMOD_PIN_9_GPIO_CLK_DISABLE(); } else \
                                                         if((__TAG_PIN__) == TAG_PIN3 ) { STMOD_PIN_10_GPIO_CLK_DISABLE(); } else \
                                                         if((__TAG_PIN__) == TAG_PIN4 ) { STMOD_PIN_11_GPIO_CLK_DISABLE(); } } while(0)
