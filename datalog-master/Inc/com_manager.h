...
#define HSD_JSON_VERSION_MINOR '0'
...
#define HSD_DEVICE_PNUMBER_LENGTH           16U
#define HSD_DEVICE_URL_LENGTH               32U
#define HSD_DEVICE_FW_NAME_LENGTH           16U
...
/* Context is only used in the firmware, it's not written into DeviceConfi.json */
typedef struct
{
